...
<body>
	...
	<div class="container bg-info" style="padding-top: 20px; padding-bottom: 20px;">
		<h3>Test Middle BE Prabowo H. Kesuma</h3>
		<hr>
		<div class="row">
			<div class="col-sm-4">
				<h3>Tambah Buku</h3>
				<form role="form" action="insert.php" method="post">
					...
					<div class="form-group">
						<label>Category Buku</label>
						<input type="text" name="catm_bk" class="form-control">
					</div>
					<div class="form-group">
						<label>Keywords Buku</label>
						<input type="text" name="keyword_bk" class="form-control">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="stock_bk" class="form-control">
					</div>
					<div class="form-group">
				...
				<table class="table table-striped table-hover dtabel">
					...
					<tbody> 
						...
						<tr>
							...
							<td><?php echo $row['category_buku']; ?></td>
							<td><?php echo $row['keyword_buku']; ?></td>
