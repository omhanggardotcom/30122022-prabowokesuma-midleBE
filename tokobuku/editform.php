...
<div class="container bg-info" style="padding-top: 20px; padding-bottom: 20px;">
	...
	<form role="form" action="edit.php" method="get">
		...
		<div class="form-group">
			...
			<input type="text" name="catm_bk" class="form-control" value="<?php echo $row['category_buku']; ?>">			
		</div>

		<div class="form-group">
			<label>Keywords Buku</label>
			<input type="text" name="keyword_bk" class="form-control" value="<?php echo $row['keyword_buku']; ?>">			
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="stock_bk" class="form-control" value="<?php echo $row['stock']; ?>">			
		</div>
